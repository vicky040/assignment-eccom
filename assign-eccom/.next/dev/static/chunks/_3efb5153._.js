...
function initializeProducts() {
    if (products.length === 0) {
        products = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$placeholder$2d$images$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PlaceHolderImages"].map((img, index)=>{
            const productNames = [
                "Quantum-Charged Mug",
...
class CouponCartStore {
    ...
    generateNthOrderDiscount(force = false) {
        ...
        const newDiscount = {
            code: `SAVE10-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])().substring(0, 8).toUpperCase()}`,
            percentage: 10,
            isUsed: false
        };
...
function Home() {
    ...
    const products = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["store"].getProducts();
...
//# sourceMappingURL=_3efb5153._.js.map